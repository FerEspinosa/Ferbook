...
public class MyFirebaseMessagingClient extends FirebaseMessagingService {
    ...
    private void showNotificationMessages (Map<String, String> data){
        ...
        getSenderImage(senderImage, receiverImage, data);

    }

    private void getSenderImage(String senderImage, String receiverImage, Map<String, String> data) {
        //colocar las imagenes del sender y del receiver en la notificacion
                    ...
                    public void run() {
                        Picasso.with(getApplicationContext()).load(senderImage).into(new Target() {
                            ...
                            public void onBitmapLoaded(Bitmap bitmapSender, Picasso.LoadedFrom from) {
                                getReceiverImage(data, bitmapSender, receiverImage );
                            }

                            @Override
                            public void onBitmapFailed(Drawable errorDrawable) {
                                getReceiverImage(data, null, receiverImage);
                            }
    ...
    private void getReceiverImage (Map<String, String> data, Bitmap bitmapSender, String receiverImage) {
